...
class CustomWidget(QWidget):
    def __init__(self):
        ...
        self.centerWidget.setContentsMargins(5, 0, 5, 0)  # 设置内容区域的边距
        self.centerWidgetLayout = QHBoxLayout(self.centerWidget)
        self.centerWidgetLayout.setContentsMargins(0, 0, 0, 0)

        self.resize_handle = ResizeHandle(self)
        self.layout.addWidget(self.resize_handle)

    def setCenterWidget(self, side_widget, content_widget):
        """
        设置中心部件
        ...
        :return:
        """
        self.centerWidgetLayout.addWidget(side_widget)
        self.centerWidgetLayout.addWidget(content_widget)
